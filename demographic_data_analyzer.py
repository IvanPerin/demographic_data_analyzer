...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round(df[df['education'] == 'Bachelors']['education'].count()
    ...
    higher_education_rich = round(df.loc[higher_education & (df['salary'] == '>50K'), 'salary'].count() 
                                  / df.loc[higher_education, 'salary'].count() *100, 1)
    lower_education_rich = round(df.loc[lower_education & (df['salary'] == '>50K'), 'salary'].count() 
                                 / df.loc[lower_education, 'salary'].count() *100, 1)
